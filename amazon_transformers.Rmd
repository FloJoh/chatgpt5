...
Den här filen kopierar kod från: https://www.analyticsvidhya.com/blog/2019/06/comprehensive-guide-text-summarization-using-deep-learning-python/ 

och modellen byggs från:
https://www.tensorflow.org/text/tutorials/transformer

Modellen kan ännu inte köras utan att krasha r så vidtag försiktighet


```{python}
import amazon_reviews_tokenizer
```
...
```{python}
data=pd.read_csv("reviews_folder/Reviews.csv",nrows=100000)
```
