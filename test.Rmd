...
In our model for the transformer we have the same issue of the model not learning after an early epoch which we may assume is the result of the same issue with data size. We may also assume that training was done in too short of a time-span for the models to make a comparison.